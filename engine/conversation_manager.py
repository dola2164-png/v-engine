    ...
    def handle_reply(
        ...
        if intent == "QUESTION":
            ...
            return {
                ...
                "cta": "binary_confirm",
                "intent": intent,
                "rationale": "Answered merchant question accurately using context without hallucination and redirected to draft."
            }
        ...
        if intent == "COMMIT":
            ...
            if conv.get("state") in ("DRAFT_READY", "COMMITTED"):
                ...
                body = (
                    f"Done! I've prepared the campaign draft for {m_name}. "
                    "Here is the plan: outreach structured for your 245 members with your active offer. "
                    "Confirm to proceed with rollout."
                )
                cta = "binary_confirm"
